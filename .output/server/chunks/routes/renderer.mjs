...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","href":"/logo.png"},{"rel":"stylesheet","href":"/helpers.css"},{"rel":"stylesheet","href":"/bootstrap.min.css"},{"rel":"stylesheet","href":"/style.css"}],"style":[],"script":[],"noscript":[],"title":"Star"};
